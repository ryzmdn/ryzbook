  ...
  return (
    <header aria-labelledby="website-header" className="mx-auto w-full max-w-2xl bg-transparent px-3 py-16">
      ...
      <div className="mb-8 flex justify-center">
        <div className="relative rounded-full px-3.5 py-1 text-sm/6 inline-flex items-center bg-pink-50 font-medium text-pink-700 ring-1 ring-pink-700/10 ring-inset">
          This guestbook is open source only on GitHub.{" "}
          <Button href="https://github.com/ryzmdn/ryzbook" variant="text" aria-label="Visit github repository" defaultStyle={false} shadow={false} className="text-pink-900 font-semibold">
      ...
      <div className="text-center">
        ...
        <p className="mt-8 font-medium text-pretty text-gray-700 sm:text-base/8">
