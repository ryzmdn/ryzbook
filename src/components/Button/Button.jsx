...
const variantStyles = {
  primary: "bg-pink-600 text-gray-50 hover:bg-pink-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600",
