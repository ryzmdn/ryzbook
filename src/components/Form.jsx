...
export function Form({
  ...
  const handleSubmitButton = () => {
    if (canSendMessage) {
      return (
        <>
          <Svg width={16} height={16} draw={["M3.478 2.404a.75.75 0 0 0-.926.941l2.432 7.905H13.5a.75.75 0 0 1 0 1.5H4.984l-2.432 7.905a.75.75 0 0 0 .926.94 60.519 60.519 0 0 0 18.445-8.986.75.75 0 0 0 0-1.218A60.517 60.517 0 0 0 3.478 2.404Z"]} className="-rotate-45 -translate-y-0.5" />
          Send message
        </>
      );
    } else {
      return (
        <>
          <Svg width={16} height={16} draw={["M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 0 0 0-1.5h-3.75V6Z"]} className="-rotate-45" />
          Please wait 1 hour
        </>
      );
    }
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 sm:px-6">
        ...
        >
          ...
          <div className="ml-3 flex h-7 items-center">
            ...
            >
              <Svg width={20} height={20} draw={["M5.47 5.47a.75.75 0 0 1 1.06 0L12 10.94l5.47-5.47a.75.75 0 1 1 1.06 1.06L13.06 12l5.47 5.47a.75.75 0 1 1-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 0 1-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 0 1 0-1.06Z"]} />
            </Button>
          </div>
        </header>
        <div className="mt-1">
